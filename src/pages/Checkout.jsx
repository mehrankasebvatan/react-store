...
const Checkout = () => {
    const {
         getCartItemsWithProducts, updateQuantity, removeFromCart, clearCart, getCartTotal
    } = useCart()
            ...
            <div className="container">
                ...
                <div className="checkout-container">
                    <div className="checkout-items">
                        ...
                        {cartItems.map((item) => (<div key={item.id} className="checkout-item">
                                <img
                    ...
                    <div className="checkout-summary">
                        ...
                        <div className="checkout-total">
                            <p className="checkout-total-label">Discount:</p>
                            <p className="checkout-total-value">$0.00</p>
                        </div>
